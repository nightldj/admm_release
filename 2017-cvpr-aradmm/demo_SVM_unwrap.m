...
opts.adp_flag = 0;
opts.gamma = 1;
[sol1, outs1] =aradmm_SVM_unwrap(D, c, svm_C, opts);
fprintf('vanilla ADMM complete after %d iterations!\n', outs1.iter);

% relaxed ADMM
opts.adp_flag = 0;
opts.gamma = 1.5;
[sol2,outs2] =  aradmm_SVM_unwrap(D, c, svm_C, opts);
t2 = outs2.runtime;
...
opts.gamma = 1;
[sol3,outs3] = aradmm_SVM_unwrap(D, c, svm_C, opts);
t3 = outs2.runtime;
...
opts.adp_flag = 1;
opts.gamma = 1;
[sol4,outs4] = aradmm_SVM_unwrap(D, c, svm_C, opts);
t4 = outs4.runtime;
...
opts.adp_flag = 5; 
opts.gamma = 1;
[sol6,outs6] = aradmm_SVM_unwrap(D, c, svm_C, opts);
t6 = outs6.runtime;
